...
public class SteamCrawler {
    ...
    public static void main(String[] args) throws Exception {
        ...
        conversionRateUSDinEUR = CurrencyHelper.getConversionRateToEuro("USD");
        ...
        while (iteration < MAX_ITERATION) {
            while (!iteration_successfull) {
                try {
                    ...
                    LOGGER.info("Program got interrupted.");
                    return;
                } catch (Exception e) {
                    wait_counter++;
                }
        ...
        public static @NotNull Boolean getItemsforSteamPageNumber (int pageNumber) throws Exception {
            ...
            if (pageNumber % 50 == 0) {
                conversionRateUSDinEUR = CurrencyConverter.getUSDinEURO();
                System.out.println("Conversion Factor from USD to EUR: " + conversionRateUSDinEUR);
            }
