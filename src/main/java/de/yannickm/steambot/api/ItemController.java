...
import de.yannickm.steambot.service.InsertItemsService;
...
public class ItemController {
    ...
    @RequestMapping("AddSteamPrices")
    @PostMapping
    public void addNewSteamPrices(@RequestBody com.fasterxml.jackson.databind.JsonNode payload) throws Exception {
        insertItemsService.addNewSteamPrices(payload);
    }
