package de.yannickm.steambot.crawler.buffcrawler;
...
public class buffCrawler {
    ...
    public static double getBuffItemNoExterior(int id) throws Exception {
        ...
        List<DomElement> Items = page.getByXPath("//*[contains(@class, 'f_Strong')]");
    ...
    public static double getBuffItemWithExterior(int id) throws Exception {
        ...
        List<DomElement> Items = page.getByXPath("//*[contains(@class, 'scope-btns')]");
